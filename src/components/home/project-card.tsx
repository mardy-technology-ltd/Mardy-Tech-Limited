...
export function ProjectCard({ project, priority = false }: ProjectCardProps) {
  return (
    ...
    >
      <TiltCard className="group flex flex-col justify-between overflow-hidden border border-border/60 bg-card shadow-xs transition-colors hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5 h-full">
        ...
        {/* Card Action Links */}
        <div className="p-6 pt-4 border-t border-border/40 mt-4 flex items-center justify-between gap-3 relative z-10">
          <Link
